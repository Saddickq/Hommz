  ...
  return (
    <div className="bg-gray-100 -mx-8 lg:px-32 px-8 animate-pulse">
      ...
      <div className="py-8 flex flex-col sm:flex-row gap-8">
        <div className="border-t rounded border-gray-300 w-full">
        </div>
      </div>
    </div>
  );
