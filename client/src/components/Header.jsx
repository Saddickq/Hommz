        ...
        <header className="py-2 border-b border-gray-300 px-1 md:px-8 md:py-3">
            <div className="flex flex-col sm:flex-row justify-between items-center w-full">
                <div className="flex justify-between w-full sm:w-auto">
                    <Link to='/' className="flex gap-1 items-center transition duration-300">
                    ...
                    <div className="flex sm:hidden gap-4 items-center transition duration-300">
                        {!!user
                            ? 
                            ...
                            :
                            <button onClick={()=>setShowAuth(true)} className="border border-gray-300 rounded-full text-sm md:text-base py-2 px-4">Sign In</button>
                        }
                    </div>
                </div>
                <div className="flex items-center gap-4 border shadow rounded-full p-1 cursor-pointer hover:shadow-md mt-2 md:mt-0 max-w-50 transition duration-300">
                    <div className="border-r text-sm md:text-base pr-3 pl-4 border-gray-300">Anywhere</div>
                    <div className="border-r text-sm md:text-base pr-3 border-gray-300">Any week</div>
                    <div className="text-gray-500 text-sm md:text-base">Add guests</div>
                    <button className="bg-primary rounded-full p-2 m-1 md:m-0 text-white">
                        <IoSearchSharp className="size-4 md:size-5" /> 
                    </button>
                </div>
                <div className="hidden sm:flex gap-4 md:gap-8 transition duration-300 items-center">
                    {!!user
                        ? 
                        <Link to="/account" className="flex items-center gap-1 border border-gray-300 rounded-full py-1 px-2 hover:shadow-md">
                            <RxHamburgerMenu className="size-4 md:size-6" />
                            <FaCircleUser className="size-8 text-slate-600" />
